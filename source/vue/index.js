...
Vue.prototype._update = function(vnode){
    ...
    // let node = document.createDocumentFragment(); // 文档碎片，dom放在内存中，1.0的实现方式
    // let firstChild;
...
Vue.prototype.$mount = function () {
    ...
    new Watcher(vm,updateComponent); // 渲染watcher,初始化渲染，默认会调用updateComponent这个方法
    // 我们需要让每个数据 它更改了 需要重新的渲染
};
...
// this.getter(); // 当前属性的get方法  给当前的属性加一个dep  dep.addSub(watcher) dep
// popTarget();
